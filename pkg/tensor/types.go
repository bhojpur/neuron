...
// which allows for easy reflection operations. It also implements hm.Type, for type inference in
// Bhojpur Neuron
type Dtype struct {
	reflect.Type
}

// note: the Name() and String() methods are already defined in reflect.Type. Might as well use the
// composed methods
